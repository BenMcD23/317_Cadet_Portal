...
// Waist + leg fields
export const WAIST_LEG_ITEMS = new Set(["Trousers", "Slacks", "Skirt"])

// Chest field
export const CHEST_ITEMS = new Set([
  "Wedgewood Male", "Wedgewood Female",
  "Working Blue Male", "Working Blue Female",
  "Jumper",
])

// Collar field (shirts only)
export const COLLAR_ITEMS = new Set([
  "Wedgewood Male", "Wedgewood Female",
  "Working Blue Male", "Working Blue Female",
])

// Seat field (L/W/S) — Trousers only
export const SEAT_ITEMS = new Set(["Trousers"])

// Hips field (L/W/H) — Slacks and Skirt
export const HIPS_ITEMS = new Set(["Slacks", "Skirt"])
